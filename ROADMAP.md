...
- stabilize the current beta contribution engine
- improve first-real-PR success rate
- narrow large-repo targeting more intelligently
- make onboarding safer for public open-source users
- add API-key-only backend support later, without weakening contribution guardrails
